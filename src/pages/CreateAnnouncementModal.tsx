      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-4 sm:p-6 rounded-t-2xl">
          <div className="flex items-center justify-between text-white">
            <h3 className="text-lg sm:text-xl font-bold">Create New Announcement</h3>
            <button 
              onClick={handleClose} 
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
              ...
              <button
                ...
                onClick={handleClose}
                disabled={isSubmitting}
                className="order-1 sm:order-2 sm:flex-shrink-0 px-6 py-3 border border-slate-300 text-slate-700 rounded-xl hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation text-sm sm:text-base"
              >
                Cancel
              </button>
            </div>
