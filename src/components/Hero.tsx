  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900/60 via-indigo-900/40 to-purple-900/50"></div>
      </div>
      ...
      <div className="relative z-10 text-center text-white px-4 md:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 font-serif italic text-blue-200 drop-shadow-md">
            "A Community Where Traditions Meet Modern Living"
          </p>
          
          <p className="text-lg md:text-xl mb-12 text-slate-200 max-w-2xl mx-auto leading-relaxed drop-shadow-sm">
      ...
      <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-br from-amber-300/20 to-yellow-400/20 rounded-full blur-xl animate-float"></div>
      <div className="absolute top-40 right-20 w-32 h-32 bg-gradient-to-br from-blue-300/15 to-indigo-400/15 rounded-full blur-2xl animate-pulse"></div>
      <div className="absolute bottom-32 left-20 w-16 h-16 bg-gradient-to-br from-purple-300/25 to-pink-400/25 rounded-full blur-lg animate-bounce"></div>
